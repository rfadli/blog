...
class BlogController extends BackendController
{
        ...
        if($request->hasFile('image'))
        {
            ...
            if($successUploaded)
            {
                ...
                Image::make($destination . '/' . $fileName)
                        ->resize($width, $height) //width & height config on /config/cms.php
    ...
    public function forceDestroy($id)
    {
        ...
        return redirect('/backend/blog?status=trash')->with('message', 'Your post has been deleted successfuly');
    }
    ...
    //    return redirect('/backend/blog')->with('message', 'You Post Has Been Move From The Trash');
       return redirect()->back()->with('message', 'You Post Has Been Move From The Trash');
    }
